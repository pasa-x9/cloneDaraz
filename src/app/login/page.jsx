                    ...
                    <div className='m-auto md:w-[68vw] py-16 px-8'>
                        ...
                        <form action="" className=' bg-white/30 shadow-xl w-full py-12 md:px-44 sm:px-8 px-6'>
                            <fieldset className=' flex gap-6 flex-col'>
                                <legend className='text-orange-600 font-semibold md:text-[1.4vw] my-4 h-ani'>Login Into Daraz</legend>
                                ...
                                <button type="submit" className='bg-orange-600 w-full text-center text-white p-3 hover:bg-orange-500'>Login</button>
                                <span className='text-center text-xs m-[-6px] text-slate-500'>-- OR --</span>
                                <button className='bg-orange-600 w-full text-center text-white p-3 hover:bg-orange-500'><Link href='/login/register'>Sign Up</Link></button>
                            </fieldset>
                        </form>
                    </div>
                </div>
