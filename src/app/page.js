...
export default function Home() {
  ...
  return (
     ...
     <section className="py-4">
      <div className="container flex gap-6 text-nowrap">
     ...
     <section className="py-4">
     <h1 className="container sm:text-2xl text-xl font-bold my-6">All Products</h1>
      <div className="container grid sm:grid-cols-4 md:grid-cols-6 grid-cols-2 gap-8">
        {products.map((a)=>(
          <div className="shadow-lg outline outline-1 outline-slate-200 p-2 sm:h-fit h-git text-nowrap relative">
